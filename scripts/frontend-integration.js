 ...
 * This file demonstrates how to integrate Nftcraft with a web frontend
 */

// For React/Vue/Angular applications
export class NftcraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NftcraftClient(provider, contractAddress);
